...
!(function (t, e, n) {
  ...
  var i = e.documentElement,
    ...
    o = {
      ...
      touch: !!(
        "ontouchstart" in t ||
        (t.navigator && t.navigator.msPointerEnabled && t.MSGesture) ||
      ...
      testAll: function () {
        var t = " js";
        for (var e in this)
          "testAll" !== e && "constructor" !== e && this[e] && (t += " " + e);
              ...
              try {
                ...
                if (t && ("object" == typeof t || "function" == typeof t)) {
                  ...
                  if ("function" == typeof e)
                    return void h(i(e, t), i(s, this), i(a, this));
                }
            ...
            (r.prototype["catch"] = function (t) {
              ...
              (r.all = function () {
                var t = Array.prototype.slice.call(
                  1 === arguments.length && p(arguments[0])
                    ? arguments[0]
                    : arguments
                );
            ...
            preventCheck: function (t, e) {
              return e && e.href
                ? t.which > 1 ||
                  ...
                  : e.href.indexOf("#") > -1
                  ? !1
                  : i.cleanLink(e.href) == i.cleanLink(location.href)
                  ? !1
                  : !e.classList.contains("no-barba")
                : !1;
            },
        ...
        var n = {
          ...
          putContainer: function (t) {
            (t.style.visibility = "hidden"),
              document.getElementById("barba-wrapper").appendChild(t);
          },
          parseContainer: function (t) {
            return t.querySelector(".barba-container");
          },
        };
        t.exports = n;
      },
        ...
        for (var o in t) {
          ...
          for (var a in this.waypoints[o]) {
            ...
            d.element !== d.element.window &&
              (g = d.adapter.offset()[s.offsetProp]),
              "function" == typeof f
                ? (f = f.apply(d))
                : "string" == typeof f &&
                  ((f = parseFloat(f)),
  ...
  CubicBezier.create("custom-0.25", 0.25, 0.1, 0.25, 1),
  CubicBezier.create("custom-0.63-0.38", 0.63, 0.01, 0.38, 1),
  CubicBezier.create("custom-0.63-0.25", 0.63, -0.01, 0.25, 1),
  CubicBezier.create("custom-0.66", 0.66, 0.01, 0.25, 1),
  CubicBezier.create("custom-0.68", 0.68, 0.02, 0.35, 1.01),
  CubicBezier.create("custom-0.74", 0.74, 0, 0.22, 1.01),
  CubicBezier.create("custom-0.84", 0.84, 0, 0.25, 1),
  (TweenLite.defaultEase = Power1.easeOut),
  (Barba.Pjax.load = function (t) {
    var e,
      n = Barba.Utils.deferred(),
      i = this;
    return (
      (e = this.Cache.get(t)),
      e || ((e = Barba.Utils.xhr(t)), this.Cache.set(t, e)),
      e.then(
        function (t) {
          ...
          if (
            ...
            void 0 === imagesLoaded || "function" != typeof imagesLoaded)
          )
            return n.resolve(e);
          ...
          r.on("progress", function (t, e) {
            ...
            Barba.Dispatcher.trigger("newPageProgress", n);
          }),
            r.on("always", function (t) {
              Barba.Dispatcher.trigger("newPageProgress", 1), n.resolve(e);
            });
        },
        function () {
  ...
  //    t.dataset && t.dataset.namespace && Barba.Pjax.History.storeNamespace(t.dataset.namespace)
  //})
  Barba.Dispatcher.on("initStateChange", function (t) {
    app.disableScroll(),
      menu.close(),
      TweenLite.killTweensOf(loader.$progressbar),
      TweenLite.killTweensOf(loader.$progressbar_inner),
      t.namespace || Barba.Pjax.History.setCurrentNamespace();
  }),
  Barba.Dispatcher.on("newPageReady", function (t, e) {
    app.inlineSVG();
  }),
  Barba.Dispatcher.on("newPageProgress", function (t) {
    loader.progress(t);
  }),
  Barba.Dispatcher.on("transitionCompleted", function (t, e) {
    if (
      ...
      app.enableScroll(!1),
      app.resetWaypoints(),
      TweenLite.set(Barba.Pjax.Dom.getContainer(), {
        opacity: 1,
      }),
      "undefined" != typeof e)
    ) {
      var n = "white";
      (t.namespace && -1 === ["page", "contact"].indexOf(t.namespace)) ||
        (n = "black"),
        app.setHeaderColor(n);
    }
  }),
  (Barba.HistoryManager.getNamespace = function (t) {
  ...
  (Barba.HistoryManager.storeNamespace = function (t) {
    this._namespace = t;
  }),
  (Barba.HistoryManager.setCurrentNamespace = function () {
    if ("undefined" != typeof this._namespace) {
      ...
      t &&
        (this._namespace || (this._namespace = this.getNamespace(t.url)),
...
var BasicTransition = Barba.BaseTransition.extend({
  start: function () {
    var t = this;
    Promise.all([this.exit(), this.progress(), this.newContainerLoading]).then(
      function () {
        var e = Barba.Pjax.History.currentStatus();
        "project" !== e.namespace &&
          TweenLite.set(loader.$progressbar, {
  ...
  exit: function () {
    ...
    var r = Barba.Pjax.History.prevStatus(),
      o = Barba.Pjax.History.currentStatus(),
      s = this.getColor(r.namespace),
      a = "";
    "home" === o.namespace
      ? (a = first_project_color)
      : "#fff" === s && (a = loader.$progressbar.data("initial-color")),
      a &&
        e.set(loader.$progressbar_inner, {
          backgroundColor: a,
        });
    var c = "";
    return (
      (c =
        "home" === r.namespace
          ...
          : $(this.oldContainer).find(".site__content")),
      c &&
        e.to(c, 0.5, {
          opacity: 0,
          ease: Power1.easeOut,
  ...
  enter: function () {
    var t = new TimelineLite({
      ...
      e = Barba.Pjax.History.prevStatus(),
      n = Barba.Pjax.History.currentStatus(),
      i = this.getColor(e.namespace);
    loader.displayProgressbar(n.namespace),
      t
  ...
  getColor: function (t) {
    ...
    return (
      "home" === t
        ? (e = Home.getColor())
        : -1 !== ["contact", "project", "page"].indexOf(t) && (e = "#fff"),
      e
    );
  },
});
Barba.Pjax.getTransition = function () {
  var t = Barba.Pjax.History.prevStatus(),
    e = Barba.Pjax.History.currentStatus();
  return (
    e.namespace || Barba.Pjax.History.setCurrentNamespace(),
    "projects" === t.namespace && "project" === e.namespace
      ? ProjectsToProjectTransition
      : "home" === t.namespace && "project" === e.namespace
      ? HomeToProjectTransition
      : "project" === t.namespace && "project" === e.namespace
...
var loader = {
  ...
  init: function () {
    $("body").removeClass("loaded ready"),
      (this.$progressbar = $(".progressbar")),
      (this.$progressbar_inner = $("#progressbar").show());
    var t = this.$progressbar.css("background-color");
    this.$progressbar.data("initial-color", t),
      (this._progress = 0),
  ...
  start: function () {
    ...
    if (!this.done) {
      var e = new TimelineLite({
        delay: 0.6,
        onComplete: function () {
          (this.done = !0), $("body").addClass("ready"), Barba.Pjax.start();
        },
        onCompleteScope: this,
      });
      e.set(Barba.Pjax.Dom.getContainer(), {
        opacity: 1,
      })
        .set(".doors-transition_top", {
          top: 0,
        ...
        .add(function () {
          ...
          var e = Barba.Pjax.Dom.getNamespace(Barba.Pjax.Dom.getContainer());
          t.displayProgressbar(e), $("body").addClass("loaded");
        })
        .to(".doors-transition", 0.8, {
          height: 0,
          clearProps: "top, bottom",
          ease: CubicBezier.get("custom-0.74"),
        })
        .fromTo(
          [".site__logo", ".site__nav"],
          1,
          {
            autoAlpha: 0,
          },
  ...
  startProgress: function () {
    var t = this;
    return (
      (this.deferred = Barba.Utils.deferred()),
      (this._progress = 0),
      TweenLite.set(this.$progressbar_inner, {
        opacity: 1,
        left: 0,
        right: "auto",
      }),
  ...
  progress: function (t) {
    isNaN(t) ||
      ...
      TweenLite.to(this.$progressbar_inner, 0.3, {
        width: 100 * t + "%",
        ease: Power0.easeNone,
        onComplete: function (t) {
          (this._progress = t),
            1 !== t || this._timeout_id || this.endProgress();
        },
        onCompleteScope: this,
        onCompleteParams: [t],
      }));
